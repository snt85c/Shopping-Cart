...
export default function Cart({ cart, setCart }) {
  ...
  return (
    <>
      <div
        className="absolute z-20 top-18 mt-2 md:top-16 right-0 bg-gray-900 w-2/4 md:w-1/3 text-center text-sm border-amber-500 border-l-2 border-b-2 cartAnimation "
