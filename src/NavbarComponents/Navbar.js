...
export default function Navbar({ setOnScreen, cart, setCart }) {
  ...
  return (
    <>
      <div className=" w-full md:static top-0 flex  flex-col md:flex-row justify-between items-center max-w-full border-b-amber-500 dark:bg-gray-900 bg-white border-b-2 font-extrabold text-4xl rounded-t-xl ">
        <div
